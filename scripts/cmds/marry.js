...
async function bal(one, two) {
    ...
    avtwo.circle()
    let pth = "abcd.png"
    let img = await jimp.read("https://i.postimg.cc/6pMNPqKP/miyamizu-mitsuha-and-tachibana-taki-kimi-no-na-wa-drawn-by-broken-7589468-585950dfb7e96bc3dd25a6e.jpg")
