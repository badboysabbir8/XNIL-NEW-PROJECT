...
module.exports = {
    ...
    onStart: async function({
        ...
        try {
            ...
            let apiUrl = `https://samirxpikachu.onrender.com/message?text= ${encodeURIComponent(Message)}&profileUrl=${encodeURIComponent(profilePicUrl)}&name=${encodeURIComponent(profileName)}`;
